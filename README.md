...
├── .github/
│   └── workflows/
│       └── bgp-ci.yml      # CI workflow for containerized validation
├── docs/
│   └── NetDevOps-CI-CD-Documentation.pdf # Full lab reference PDF
├── venv/                   # Python virtual environment
├── data.yml                # Lab variables (ASNs, IPs, peering data)
├── template.j2             # Jinja2 template for FRR BGP configs
├── deploy.py               # Automation script to render & apply configs
├── docker-compose.yml      # Multi-router container definitions
├── .gitignore              # Ignored files and artifacts
└── README.md               # Lab documentation and runbook
